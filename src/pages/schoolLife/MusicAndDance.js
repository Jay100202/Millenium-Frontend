...
import media from "../../assets/Upload/MediaUploadFile/f383562e04e7408ca91dfbbd4c48b2f8.jpg";
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      const data = res.data.filter(
        (entry) => entry._id === "66254ff4dce9d44fabb8f0bf"
      );
          ...
          <div className="row d-flex justify-content-center">
            <div className="col-md-12">
              <div className="text-center">
                <h1 className="text-white">Music And Dance</h1>
              </div>
